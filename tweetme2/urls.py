...
urlpatterns = [
    ...
    path('<int:tweet_id>', Afcontweets_detail_view),
    path('<int:tweet_id>', Baseballtweets_detail_view),
    path('<int:tweet_id>', Bundesligatweets_detail_view),
    path('<int:tweet_id>', Championstweets_detail_view),
    path('<int:tweet_id>', Europatweets_detail_view),
    path('<int:tweet_id>', Formula1tweets_detail_view),
    path('<int:tweet_id>', Laligatweets_detail_view),
    path('<int:tweet_id>', NBAtweets_detail_view),
    path('<int:tweet_id>', NFLtweets_detail_view),
    path('<int:tweet_id>', Worldcuptweets_detail_view),
